...
@section('title', 'Pagos Completos')

@section('content')
@include('partials.estado')
<h1><i class="fa-solid fa-list"></i> Listado de Pagos Completos</h1>


<div class="actions-row">
    <a href="{{ route('pagos.create') }}" class="btn btn-primary">
        <i class="fa-solid fa-plus"></i> Realizar un Pago
    </a>
</div>
...
<div class="search-panel">
    ...
    <div class="filter-wrapper">
        <form method="GET" action="{{ route('pagos.completos') }}" class="filter-row">
                ...
                <a href="{{ route('pagos.show', $pago) }}" class="pago-enlace">
                    <div class="pago-info">
                        ...
                        <div class="pago-campo">
                            ...
                            <span class="pago-etiqueta">Fecha de Pago:</span>
                            <span class="pago-valor">{{ $pago->fecha_pago_formato ?? 'Fecha no registrada' }}</span>
                        </div>
                    </div>
                </a>
            </div>
